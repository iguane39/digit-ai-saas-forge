...
> ↩ **Einstiegspunkt:** beginne mit [run-playbook.md](run-playbook.md) — es erkennt deinen Kontext (neu / Fortsetzung / extern / Forge-Update) und leitet hierher für die A→E-Details.
